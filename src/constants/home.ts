  ...
  gateway: {
    ...
    cards: [
      ...
      },
      {
        ...
        fullBleedImage: true,
        imageClassName:
          'max-[26.5625rem]:object-contain max-[26.5625rem]:object-bottom min-[26.625rem]:object-cover min-[26.625rem]:object-top',
      ...
      },
      {
        ...
        imageWrapperClassName: 'absolute inset-6 md:inset-8 xl:right-[1.9375rem] overflow-hidden',
        imageClassName: 'object-cover object-left-top',
        gridClassName:
