...
export const buildDeployTechnologyLogos: ITechnologyLogo[] = [
  {
    ...
    width: 112,
    height: 28,
    className: 'h-5 w-20 sm:h-7 sm:w-28',
  },
  {
    alt: 'TypeScript',
    ...
    width: 110,
    height: 28,
    className: 'h-5 w-20 sm:h-7 sm:w-[6.875rem]',
  },
  {
    alt: 'Go',
    ...
    width: 75,
    height: 28,
    className: 'h-5 w-14 sm:h-7 sm:w-[4.6875rem]',
  },
  {
    alt: 'Java',
    ...
    width: 84,
    height: 40,
    className: 'h-7 w-15 sm:h-10 sm:w-[5.25rem]',
  },
];
