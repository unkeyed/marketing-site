      ...
      <div className={`${CONTAINER} flex flex-col`}>
        <div className="relative h-[420px] max-[351px]:h-[500px] md:h-[520px] xl:h-[610px]">
          ...
          <Image
            ...
            height={1202}
            sizes="100vw"
            className="absolute top-[40px] left-0 z-0 h-[380px] w-full object-cover object-[72%_50%] max-[351px]:top-[124px] max-[351px]:h-[360px] md:top-[60px] md:h-[460px] lg:top-[52px] lg:h-[470px] lg:object-center xl:top-[1px] xl:h-[600px]"
            src={dashboardImage}
          />
        </div>
