  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            'flex flex-col border border-uw-border px-5 py-10 md:px-10 lg:border-r-0 lg:px-16 lg:py-0 xl:px-24',
        ...
        >
          <div className="flex flex-col gap-4 sm:gap-5">
            ...
            <p className="max-w-[448px] text-base leading-snug text-muted-4">{row.body}</p>
          </div>
        ...
        <div className="border-x border-b border-uw-border lg:border">
          <Image
            alt={row.imageAlt}
            width={1536}
            height={1256}
      ...
      {!isLast && (
        <div
          className="h-16 border-l border-r border-uw-border"
          style={{
            backgroundImage:
    ...
    <section className="pt-20 md:pt-[120px] xl:pt-[180px]">
      <div className={cn(CONTAINER, 'flex flex-col')}>
        <div className="pt-8 md:pt-12 xl:pt-[80px]">
          ...
          <div className="mt-8 h-16 overflow-x-auto border-b border-uw-border md:mt-12 xl:mt-[80px] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            <div className="grid h-full min-w-[660px] grid-cols-5 md:min-w-0 md:w-full">
              {panels.map((row, index) => (
                <div
                  key={row.id}
                  className={cn(
                    'flex h-full w-full items-center justify-center border-l border-t border-uw-border px-4 text-base leading-[1.125] font-normal sm:text-lg md:text-xl',
