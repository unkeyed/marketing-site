...
function Card({
  ...
  return (
    <li
      className={cn(
        'flex min-h-95 flex-col overflow-hidden border border-gray-20 bg-background px-5 pt-5.5 pb-5 sm:px-6 sm:pt-6.5 sm:pb-6 xl:h-[429px] xl:px-8',
        className,
      )}
    >
      <h3 className="font-mono text-[15px] leading-tight text-gray-40">{title}</h3>
      <div className="relative min-h-[170px] flex-1 sm:min-h-[210px]">
        <Image
          alt={graphicAlt}
          width={320}
          height={293}
    ...
    <section className="pt-20 md:pt-30 xl:pt-[229px]">
      <Container className="relative flex flex-col">
        <div className="relative sm:pl-8">
          ...
          />
          <h2 className="max-w-100 font-display text-[28px] leading-[1.125] whitespace-pre-line text-foreground md:max-w-[550px] md:text-4xl lg:max-w-125 lg:text-[44px] xl:max-w-[639px] [&_mark]:-ml-1 [&_mark]:inline-flex [&_mark]:h-[27px] [&_mark]:items-center [&_mark]:bg-yellow [&_mark]:box-decoration-clone [&_mark]:pr-0 [&_mark]:pb-2 [&_mark]:pl-1 [&_mark]:text-black md:[&_mark]:h-[34px] lg:[&_mark]:h-[42px]">
            {heading}
          </h2>
