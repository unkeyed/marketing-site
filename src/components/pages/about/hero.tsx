...
export default function Hero({ title, description, values }: IHeroProps) {
  return (
    <section className="border-b border-gray-20">
      <div className="container py-12 md:py-20 xl:pt-29 xl:pb-32">
        <div className="grid gap-8 md:gap-16 2xl:grid-cols-[1fr_1fr] 2xl:gap-48">
          <div className="flex flex-col">
            <h1 className="marked-title font-display text-4xl leading-[1.125] font-normal whitespace-pre-line text-foreground md:text-5xl lg:text-6xl xl:text-[64px]">
              {title}
            </h1>
