...
import { IAuthorData, IBreadcrumbItem } from '@/types/common';
...
function PostHeader({ className, post, breadcrumbItems }: IPostHeaderProps) {
  ...
  return (
    <header className={cn('post-header', className)}>
      ...
      <p className="mt-5 text-lg leading-snug font-normal tracking-tight text-balance text-gray-60 md:text-xl md:leading-snug lg:text-2xl lg:leading-snug">
        {caption}
      </p>
      {cover ? (
