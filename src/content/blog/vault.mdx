...
_The most requested feature for Unkey has finally arrived._
...
2. **Contact us:**<br/>
   To opt in to recovery, send us an email at support@unkey.com. Send us the email from the email address associated with your workspace and include the API ID that you want to enable recovery for.
...
If you have any questions about recovery, please reach out to us on [Discord](https://unkey.com/discord) or at [support@unkey.com](mailto:support@unkey.com).
