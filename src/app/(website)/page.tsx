...
export default function HomePage() {
  return (
    <main className="relative w-full overflow-x-clip bg-background text-white">
      ...
      <BentoGateway {...contentData.gateway} />
      <FeatureProduction {...contentData.production} />
      <SectionScale {...contentData.scale} />
      <SectionObserve {...contentData.observe} />
      <CardsPortal {...contentData.portal} />
