...
function buildBody(): string {
  ...
  return [
    ...
    '## Unkey Deploy',
    '',
    'Deploy your code as containers across AWS regions. All paid plans include monthly usage credits that offset usage-based charges; beyond the included credits, you pay for actual vCPU seconds, memory GB-seconds, and egress GB. Unused credits do not roll over.',
    '',
    '### Plans',
    '',
    ...
    ratesTable,
    '',
    'You only pay for CPU time when your code is actually executing, not while idle waiting on I/O. Memory is billed for the time an instance is running; egress is billed by the gigabyte. Preview deployments are billed at the same rates as production.',
    '',
    '### Deploy Plan Limits',
    '',
    ...
    '',
    "There's no trial, but the Free tier lets you build and test Unkey without a credit card. You can upgrade anytime, and downgrades take effect at the end of your current billing cycle.",
    '',
    '**How is compute metered?**',
    '',
    "You only pay for CPU time when your code is actually executing, not while it's idle waiting on I/O or network calls. Memory is billed for the time an instance is running, and egress by the gigabyte. Unkey automatically scales your workload during low activity periods to optimize cost, without introducing cold starts.",
    '',
